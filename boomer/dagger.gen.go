...
func (r *Digger) UnmarshalJSON(bs []byte) error {
	var concrete struct{}
...
func invoke(ctx context.Context, parentJSON []byte, parentName string, fnName string, inputArgs map[string][]byte) (_ any, err error) {
	...
	case "Digger":
		...
		case "Dig":
			...
			return nil, (*Digger).Dig(&parent, ctx, n)
		default:
	...
	case "":
		return dag.Module().
			WithObject(
				dag.TypeDef().WithObject("Digger").
					WithFunction(
						dag.Function("Dig",
							dag.TypeDef().WithKind(VoidKind).WithOptional(true)).
							WithDescription("Dig keeps calling itself with a larger and larger n until it explodes.").
							WithArg("n", dag.TypeDef().WithKind(IntegerKind).WithOptional(true), FunctionWithArgOpts{DefaultValue: JSON("1")}))), nil
	default:
